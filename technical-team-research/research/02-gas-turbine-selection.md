...
*Sources: `Act as a Senior Power Plant Systems Engineer and....docx`; `what is critical here.docx` (×2 copies, content identical); datasheets in assets/datasheets/ (Kawasaki GPB80D/GPB180D, Siemens GT portfolio).*